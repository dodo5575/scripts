...
#time=`echo "(${i}-1)*9.6+${3}" | bc`
input=${2}.${i}.xst
grep "0" $input | awk "{print \$1*0.000002, \$2}" >> ${1}_X.dat
grep "0" $input | awk "{print \$1*0.000002, \$6}" >> ${1}_Y.dat
grep "0" $input | awk "{print \$1*0.000002, \$10}" >> ${1}_Z.dat
