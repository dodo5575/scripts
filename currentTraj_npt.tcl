...
# Usage: vmd -dispdev text -e $argv0 -args name structPrefix outDir dcdFreq timestep startFrame xstPrefix dimension dcdFile0 \[dcdFile1...\]
# Return the current and number of charge carriers in the selection for the frame.
# 2014/6/20


## find minimum x, y and z
proc getMinXYZ {xstPrefix} {
...
if {$argc < 5} {
    puts "vmd -dispdev text -e $argv0 -args name structPrefix outDir dcdFreq timestep startFrame xstPrefix dimension dcdFile0 \[dcdFile1...\]"
    exit
}
