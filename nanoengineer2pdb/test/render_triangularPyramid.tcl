...
set psf triangularPyramid.psf
set pdb triangularPyramid.pdb
...
color Segname T0 red
color Segname T1 green
color Segname T2 tan
color Segname T3 tan
color Segname T4 blue
color Segname T5 orange
color Segname T6 cyan
...
render TachyonLOptiXInternal triangularPyramid.tga
