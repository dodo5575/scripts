...
# Usage: python calc_EQarea_stats_blockAverage.py input dimension minTime
# Chen-Yu Li     cli56@illinois.edu
# 2014/5/20


import stats_blockAverage
...
result = stats_blockAverage.stats(area)
