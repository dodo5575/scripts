#
# to use:  vmd -dispdev text  -e computeDNAcurrent-C5.tcl
#

# define trajectory and structure files

set psffile /home/alek/HEMOLYSIN/30_AMIT-58/MUTATE_58/EQUIL-C5/final-C5.psf

set dcdfile /Scr/alek/GRID_FORCE-COBALT/EQUIL-C5/output/gridForce-C5_Runs0-9_25ps_wrap.dcd
#set dcdfile tmp.dcd
...
set geometryFile channelFluctuations.dat
