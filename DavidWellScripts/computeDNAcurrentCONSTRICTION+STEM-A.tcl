#
# to use:  vmd -dispdev text -e channelShape.tcl -args <psf> <dcd> <timestep>
#

# define trajectory and structure files

source /home/david/Work/Scripts/Procs.tcl
...
set dcdfile ${dcdfile}.CONSTRICTION+STEM
set geometryFile /home/david/Work/Scripts/GRIDFORCE/channelFluctuationsCONSTRICTION+STEM.dat
