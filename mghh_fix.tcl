...
# Usage: vmd -dispdev text -e $argv0 -args inPSF inPDB outPDB  
...
proc mghhFix {inPSF inPDB outPDB} {
    ...
    set molID [mol load psf $inPSF pdb $inPDB]
...
if {$argc < 2} {
    puts "vmd -dispdev text -e $argv0 -args inPSF inPDB outPDB"
    exit
}
