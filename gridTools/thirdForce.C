...
{
  if ( argc != 7 ) {
    printf("Make a force grid as for the DNA specific interaction described in Comer et al. 2009, Biophys. J. 96:593.\n");
    printf("Also used for SiO2 annealing in Comer et al. 2010, Nanopore Protocols\n");
    printf("Usage: %s coordFile basisFile dx radius0 sigma outFile\n",argv[0]);
    return 0;
  }
