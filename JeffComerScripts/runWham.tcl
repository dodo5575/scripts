...
set indexFile window_${name}_ions1.txt
set outFile pmf_ions_${name}.dat
set binN 50
set tol 0.0001
set dir .
set cut0 0.1
...
set levelZ0 [lindex $cen end-1]
set levelZ1 [lindex $cen end]

set ret [wham z $binN $cen $spring $outFile $levelZ0 $levelZ1 $tol]
