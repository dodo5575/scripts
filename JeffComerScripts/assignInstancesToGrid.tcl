...
if {$argc < 8} {
    puts "Usage: ./assignInstancesToCyl.tcl isBinary skipSteps instanceSteps dt systemGrid outDir outName logFile0 logFile1..."
    ...
    puts "systemGrid is the dx file that gives the system size--used for assigning points and wrapping."
...
proc distributeCorrBinary {gridVar inFileList outDir outName skipSteps trajSteps dt} {
    upvar $gridVar grid
    set timestep 1.0
...
if {$isBinary} {
    set n [distributeCorrBinary grid $inFileList $outDir $outName $skipSteps $instanceSteps $dt]
} else {
