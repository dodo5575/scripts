...
# edited with VMD.
# Usage: tclsh insertPsfAtomRecords.tcl 
# Author: Jeff Comer <jcomer2@illinois.edu>

if {$argc < 3} {
    puts "Usage: tclsh insertPsfAtomRecords.tcl recordPsf completePsf outPsf"
    exit
}

# Input
set recordPsf [lindex $argv 0]
set completePsf [lindex $argv 1]
# Output
