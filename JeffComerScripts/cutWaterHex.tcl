...
set name pore40+dopc
# Input: 
set psf ${name}_sol.psf
set pdb ${name}_sol.pdb 
# Output:
...
set waterText "water";# This is the stuff that is removed.
# This selection forms the basis for the hexagon.
set selText "resname SIO2 SIO SIN"
...
set violators [lsort -unique [$w get {segname resid}]]; quiet
$w delete

# Remove the offending water molecules.
puts "Deleting [llength $violators] offending water molecules..."
resetpsf
readpsf $psf
coordpdb $pdb
