...
set resB0 60; # first resid of negative run
set nBasepairs 1; # last basepair is resA0+nBasepairs-1 and resB0-nBasepairs+1
set spring 4

# Input:
set psf trap_periodic.psf
set pdb trap_periodic.pdb
# Output:
set outPrefix trap_periodic_fix
