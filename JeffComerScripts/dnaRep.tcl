...
foreach seg $segList dark $darkList light $lightList {
    ...
    #mol selection "segname $seg and name \"C.*\" \"O.*\" and name $backbone"
    mol selection "segname $seg and not name \"H.*\" and name $backbone"
    mol material Opaque
    mol addrep top

    mol representation VDW 0.800000 15.000000
    mol color ColorID $light
    #mol selection "segname $seg and not name \"C.*\" \"O.*\" and name $backbone"
    mol selection "segname $seg and name \"H.*\" and name $backbone"
    mol material Opaque
    mol addrep top

    mol representation Licorice 0.500000 15.000000 15.000000
    mol color ColorID $dark
    ...
    mol representation Licorice 0.500000 15.000000 15.000000
    mol color ColorID $light
    mol selection "segname $seg and name \"H.*\" and not name $backbone"
    mol material Opaque
    mol addrep top
}
...
mol color ColorID 6
mol selection {resname SIN SIO2 and x+y>0}
mol material Dead
mol addrep top
