...
if {$argc < 2} {
    puts "Usage: tclsh blockAvgSe.tcl windowSize minimumTime inputFile0 \[inputFile1\]..."
    exit
}

set window [lindex $argv 0]
set minTime [lindex $argv 1]
# Input:
...
puts "Ignoring data with time < $minTime."
if {![string is double $window]} {
    puts "ERROR: The minimum time must be a floating-point number."
    exit
}
