...
if {$argc < 1} {
    puts "Usage: tclsh $argv0 minTime inputFile0 \[inputFile1\]..."
    exit
}

# Input:
set minTime [lindex $argv 0]
set inFileList [lrange $argv 1 end]
# Output:
set outSuffix dat

if {![string is double $minTime]} {
    puts "ERROR: minTime must be a real number."
    exit
}
