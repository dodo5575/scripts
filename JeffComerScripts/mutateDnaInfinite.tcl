...
# Input:
set templatePsf kcl_DNA.1000.psf
set templatePdb kcl_DNA.1000.pdb
set templateSeg ADNA
set topFile top_all27_na.rtf
set nucleoDir dna
set nucleoSuffix "_char"
# Output:
set psf ADNA_CG.1000.psf
set pdb ADNA_CG.1000.pdb
...
puts "Linking $outSeg:$resLast $outSeg:$resFirst"
patch LKNA $outSeg:$resLast $outSeg:$resFirst 
