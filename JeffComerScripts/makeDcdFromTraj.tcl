...
# Input
set inTrajList {reserve2.0.traj reserve3.0.traj}
set outDir dcd
set stride 1
set startFrame 0
...
proc writeDcd {inTraj outDir startFrame stride} {
    global nullPos
    # Load the trajectory.
    set outPrefix [trimExtension $outDir/$inTraj]
    set allFrames [readPositions $inTraj]
...
foreach inTraj $inTrajList {
    writeDcd $inTraj $outDir $startFrame $stride
}
