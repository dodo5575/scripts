...
# Find average mass of target atoms, to normalize total force
#set totalmass 0
#foreach mass $masses {
#    set totalmass [expr $totalmass + $mass]
#}
#set avgmass [expr $totalmass/$numatoms]
...
proc calcforces { } {
	...
	#    print "Recalculating forces at $printcount"
	    ...
	    set force "[expr -$forcemult*$x] [expr -$forcemult*$y] [expr -0.00108*($z+1.850)]"
	    ...
	    set ft [expr 69.5*$numatoms*[lindex $force 2]]
	    print "Step ${printcount}: center $center force $ft"
