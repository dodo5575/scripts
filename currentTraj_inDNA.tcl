...
set DNA_up_sel   "nucleic and segname SC2 SC3"
set DNA_down_sel "nucleic and segname SC0 SC1"
set D 15
...
proc computeCurrentX {frameCurr selText charge lX dt cutX0 cutX1 DNA_up_bound DNA_down_bound} {
    set frameLast [expr $frameCurr-1]

    set sel [atomselect top "$selText and z < $DNA_up_bound and z > $DNA_down_bound"]
...
proc computeX {name structPrefix outDir dcdFreq timestep startFrame cutX0 cutX1 dcdList} {
    ...
    set DNA_up [atomselect top $DNA_up_sel]
    set DNA_down [atomselect top $DNA_down_sel]
	...
	for {set f $startFrame} {$f < $nFrames} {incr f} {
            ...
            set DNA_up_bound [expr [lindex [measure center $DNA_up] 2] + $D]            
            set DNA_down_bound [expr [lindex [measure center $DNA_down] 2] - $D]            
		...
		set data [computeCurrentX $f $s $q $cutDX $dt $cutX0 $cutX1 $DNA_up_bound $DNA_down_bound]
